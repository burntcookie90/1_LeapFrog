cmd_/nethome/vrajeevan3/proj1/hello/hello.o := gcc -Wp,-MD,/nethome/vrajeevan3/proj1/hello/.hello.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.1.2/include -D__KERNEL__  -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -fno-delete-null-pointer-checks -O2  -mtune=generic -m64 -mno-red-zone -mcmodel=kernel -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -funit-at-a-time -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -fstack-protector -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(hello)"  -D"KBUILD_MODNAME=KBUILD_STR(hello)" -c -o /nethome/vrajeevan3/proj1/hello/.tmp_hello.o /nethome/vrajeevan3/proj1/hello/hello.c

deps_/nethome/vrajeevan3/proj1/hello/hello.o := \
  /nethome/vrajeevan3/proj1/hello/hello.c \
...
/nethome/vrajeevan3/proj1/hello/hello.o: $(deps_/nethome/vrajeevan3/proj1/hello/hello.o)
